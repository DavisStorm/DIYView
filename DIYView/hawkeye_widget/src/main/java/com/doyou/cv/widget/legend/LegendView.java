...
import com.doyou.cv.utils.EmptyUtils;
...
public class LegendView extends LinearLayout {
    ...
    private void initAttr(AttributeSet attrs) {
        ...
        mLegendVerMargin = ta.getDimensionPixelOffset(R.styleable.LegendView_lv_legend_vertical_margin, DensityUtil.dp2px(8));
        mLabelColor = ta.getColor(R.styleable.LegendView_lv_legend_font_color, Color.rgb(42, 42, 42));
        mLabelSize = ta.getDimensionPixelSize(R.styleable.LegendView_lv_legend_font_size, DensityUtil.dp2px(12));
