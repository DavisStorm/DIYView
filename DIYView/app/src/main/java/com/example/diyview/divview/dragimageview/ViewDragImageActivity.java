package com.example.diyview.divview.dragimageview;
...
import com.example.diyview.divview.dragimageview.crop.Crop;

import java.io.File;

public class ViewDragImageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viewdragimage);
