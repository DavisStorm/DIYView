...
public class DragImageView extends View {
    ...
    public DragImageView(Context context, AttributeSet attrs) {
        super(context,attrs);
        TypedArray typedArray = getContext().getTheme().obtainStyledAttributes(attrs, R.styleable.DragImageView, 0, 0);
        int drawableResid = typedArray.getResourceId(R.styleable.DragImageView_drawable, -1);
    ...
    /**
    * 图片的宽度可能超出控件宽度，如果超出，按照最大宽度缩放，计算出居中后的图片的四周距离控件的值
    * */
    ...
    /**
    * 检查图片是否已经完全离开控件范围，如果离开再向更偏离的方向滑动，图片始终靠着控件视图的边界
    * */
