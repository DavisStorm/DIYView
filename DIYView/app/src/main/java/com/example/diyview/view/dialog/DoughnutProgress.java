package com.example.diyview.view.dialog;
...
public class DoughnutProgress extends View {
    ...
    private static final int RED = 86, GREEN = 171, BLUE = 228;
...
//        canvas.rotate(-currentAngle, 0, 0);
        ...
        //圆环外接矩形
        RectF rectF = new RectF(-raduis * doughnutRadiusPercent, -raduis * doughnutRadiusPercent, raduis * doughnutRadiusPercent, raduis * doughnutRadiusPercent);
        initPaint();
        ...
        canvas.drawCircle(raduis * doughnutRadiusPercent, 0, doughnutWidth / 2, paint);
